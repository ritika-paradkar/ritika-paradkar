...
export const mockDocuments: LegalDocument[] = [
  {
    ...
    status: "real", priority: "high", caseType: "Employment Law", confidence: 94, assignedLawyer: "L1",
  ...
  },
  {
    ...
    status: "suspicious", priority: "high", caseType: "Real Estate", confidence: 62, assignedLawyer: "L4",
  ...
  },
  {
    ...
    status: "real", priority: "medium", caseType: "Criminal Defense", confidence: 88, assignedLawyer: "L2",
  ...
  },
  {
    ...
    status: "fake", priority: "high", caseType: "Contract Dispute", confidence: 23,
  ...
  },
  {
    ...
    status: "real", priority: "low", caseType: "Intellectual Property", confidence: 97, assignedLawyer: "L3",
  ...
  },
  {
    ...
    status: "suspicious", priority: "medium", caseType: "Real Estate", confidence: 55, assignedLawyer: "L4",
